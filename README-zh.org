...
- [[#更多配置][进一步了解各种组件以及内部机制，从而灵活搭配使用]]
  ...
  + [[#用于渲染输出的-gt-render-组件][Renderer]] ([[#gt-buffer-render][gt-buffer-render]] | [[#gt-posframe-pop-rendergt-posframe-pin-render][gt-posframe-render]] | [[#gt-insert-render][gt-insert-render]] | [[#gt-overlay-render][gt-overlay-render]])
  + [[#gt-text-utility][gt-text-utility]] | [[#gt-valid-trait-if][gt-valid-trait]]
- [[#定制与扩展][可以对组件进行扩展，从而定制自己需要的功能]]
