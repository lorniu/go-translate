...
Table of Content:
- [[#installation][Installation]] | [[#basic-usage-as-a-translator][Basic Usage]] | [[#gt-http-backend][Http Client Config (url vs curl, proxy)]]
- [[#core-components][Learn more about Components for advanced usage:]]
  ...
  + [[#component-gt-render-for-rendering][Renderer]] ([[#gt-buffer-render][gt-buffer-render]] | [[#gt-posframe-pop-rendergt-posframe-pin-render][gt-posframe-render]] | [[#gt-insert-render][gt-insert-render]] | [[#gt-overlay-render][gt-overlay-render]])
  + [[#gt-text-utility][gt-text-utility]] | [[#gt-valid-trait-if][gt-valid-trait]]
- [[#customization-and-extension][Extend the components for your own requirements as you wish]]
