...
*** gt-default-cacher/gt-memory-cacher
...
Config =gt-default-http-client= to switch http client, or just make sure =curl= and [[https://github.com/alphapapa/plz.el][plz]] is exists in your system, then the component =gt-plz-http-client=
will be used as the default http client.
