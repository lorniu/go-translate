;;; go-translate-v2.el --- Translation framework supports multiple engines such as Google/Bing/DeepL -*- lexical-binding: t -*-
...
(defvar gts-supress-warning nil)

(unless gts-supress-warning
  (display-warning
   'go-translate.el
   "Break changes!

A new version of go-translate is released and many things changed.

You should migrate your config to the new APIs before the old ones be removed.

Read README.org on https://github.com/lorniu/go-translate for details.

Mask this warning by add (setq gts-supress-warning t) to your config."))
